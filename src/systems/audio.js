...
const MIX = {
    ...
    suppressed: { gain: 0.3, minGap: 20 },
    reload: { gain: 0.4, minGap: 60 },
    mainGun: { gain: 1, minGap: 90 },
    shellImpact: { gain: 0.95, minGap: 70 },
    ricochet: { gain: 0.5, minGap: 45 },
    atLaunch: { gain: 0.85, minGap: 80 },
    engine: { gain: 0.35, minGap: 0 },
    grenadeThrow: { gain: 0.55, minGap: 80 },
    smokePop: { gain: 0.6, minGap: 60 },
    flashBang: { gain: 1, minGap: 60 },
    charge: { gain: 1, minGap: 60 },
    alarm: { gain: 0.7, minGap: 400 },
    objective: { gain: 0.7, minGap: 200 },
